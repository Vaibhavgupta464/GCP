...
import { ARBITRUM_CHAIN_INFO, ARBITRUM_SEPOLIA_CHAIN_INFO } from 'uniswap/src/features/chains/evm/info/arbitrum'
...
export const { USDC: USDC_ARBITRUM_SEPOLIA } = ARBITRUM_SEPOLIA_CHAIN_INFO.tokens
...
export const UNI = {
  ...
  [UniverseChainId.ArbitrumSepolia]: new Token(
    ...
    '0x6fd79fa13998f80479f649bf04be3697e826b539', // UNI Arbitrum Sepolia (verify if needed)
    18,
    'UNI',
    'Uniswap',
  ),
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [UniverseChainId.ArbitrumSepolia]: new Token(
    UniverseChainId.ArbitrumSepolia,
    '0x0B88616c67CcEac93249d5C830c95B5A68aB8f6f',
    18,
    'WETH',
    'Wrapped Ether',
  ),
